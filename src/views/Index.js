            ...
            <Card className="bg-secondary shadow">
              <CardHeader className="bg-white border-0">
                <Row className="align-items-center">
                  <Col xs="8">
                    <h3 className="mb-0">Send an Enquiry</h3>
                  </Col>
                ...
                <Form>
                  <div className="px-4">  {/* Padding for the form */}
                    ...
                    <Row>
                      <Col md="3">
                        <FormGroup className="mb-3">
                          <label className="form-control-label" htmlFor="input-city-departure">City Departure</label>
                          <Input
                            className="form-control-alternative"
                      ...
                      <Col md="3">
                        <FormGroup className="mb-3">
                          <label className="form-control-label" htmlFor="input-delivery-city">Delivery City</label>
                          <Input
                            className="form-control-alternative"
                      ...
                      <Col md="3">
                        <FormGroup className="mb-3">
                          <label className="form-control-label" htmlFor="input-shipment-type">Shipment Type</label>
                          <Input
                            className="form-control-alternative"
                      ...
                      <Col md="3">
                        <FormGroup className="mb-3">
                          <label className="form-control-label" htmlFor="input-weight">Weight (kg)</label>
                          <Input
                            className="form-control-alternative"
                            id="input-weight"
                            placeholder="Weight"
