...
const ShipmentDetailsCustom = () => {
    ...
    const handleSubmit = async () => {
        ...
        formData.append('service_type', 'Custom Clearance');
        ...
        // Add more fields as per your form structure/screenshots
        // Example for arrays/objects:
        // formData.append('containers', JSON.stringify(containersArray));
        // formData.append('loose_cargos', JSON.stringify(looseCargosArray));
        ...
        try {
            ...
            if (contentType && contentType.includes('application/json')) {
                ...
                alert('Server returned non-JSON: ' + rawText);
            }
        } catch (err) {
